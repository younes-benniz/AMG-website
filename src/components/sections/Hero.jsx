...
function Hero() {
	return (
		<section className="flex sm:h-screen z-0 bg-hero-image bg-cover md:bg-center bg-no-repeat w-full bg-[top_right_-20rem] h-[calc(100vh_-_4rem)]">
			<div className="relative flex sm:items-center items-start overflow-hidden bg-transparent sm:pr-16 xl:pl-16 sm:pb-16 px-5 sm:mt-28 mt-20 mx-auto">
