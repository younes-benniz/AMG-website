...
function Footer() {
	const footerMenu = {
		products: ["services", "features", "vehicles", "FAQ"],
		company: ["privacy policy", "terms of service"],
	};
	return (
		<footer className="px-4 divide-y text-white bg-darkCharocoal">
			<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
				...
				<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-3/5 sm:grid-cols-3">
					<div className="space-y-3">
						<h3 className="font-header text-base tracking-wider uppercase text-white">
							Product
						</h3>
						<Divider />
						<ul className="space-y-1">
							{footerMenu.products.map((item, index) => (
								<li key={index}>
									<a
										className="text-base font-body tracking-widest capitalize text-white hover:text-brightOrange transition duration-200"
					...
					<div className="space-y-3">
						<div className="font-header text-base tracking-wider uppercase text-white">
							Social media
						</div>
						<Divider />
						<div className="flex justify-start space-x-3">
							<a
								...
								<svg
									...
									fill="currentColor"
									viewBox="0 0 32 32"
									className="w-5 h-5 lg:w-7 lg:h-7 fill-current">
			...
			<div className="flex flex-wrap gap-3 items-center justify-center py-6 text-sm font-body text-center text-gray-400">
				© 1998 Company Co. All rights reserved.
				<div className="flex items-center gap-2">
					...
					<p className="text-sm font-bold tracking-wider font-body text-white">
