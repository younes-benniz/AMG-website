...
function Hero() {
	return (
		<section className="flex sm:h-screen z-0 bg-hero-image bg-cover sm:bg-center bg-no-repeat w-full bg-[top_right_-25rem] h-[calc(100vh_-_4rem)]">
			<div className="relative flex sm:items-center items-start overflow-hidden bg-transparent sm:pr-16 sm:pb-16 px-5 sm:mt-28 mt-20 mx-auto">
				<div className="relative flex flex-col backdrop-blur-sm bg-black/50 md:p-4 md:pr-12 xl:p-12 p-10 md:w-[55%] lg:w-1/2 sm:rounded-br-full rounded-xl">
					...
					<div className="flex lg:flex-row sm:gap-0 sm:justify-start justify-center sm:items-start items-center md:mt-3 mt-8">
						<a
							href="#"
							className="px-4 md:px-2 md:py-1 py-2 mr-4 text-white uppercase bg-brightOrange border-2 border-transparent rounded-lg text-md hover:bg-brightOrange/80">
							Get one
						</a>
						<a
							href="#"
							className="px-4 py-2 md:px-2 md:py-1 text-brightOrange uppercase bg-transparent border-2 border-brightOrange rounded-lg dark:text-white hover:bg-brightOrange hover:text-white text-md">
							Learn more
						</a>
					</div>
				</div>
